...
*/
(function (root) {
  var NAVY = "#1C2746", SUN = "#FFC53D", BLUE = "#58B6E8", BLUESOFT = "#BEE5F8",
      CORAL = "#F0623E", CORALSOFT = "#FBC4B5", WHITE = "#fff";

  function limb(d) {
    return '<path d="' + d + '" fill="none" stroke="' + NAVY + '" stroke-width="30" stroke-linecap="round"/>'
  ...
  function head(mood) {
    return '<circle cx="110" cy="92" r="56" fill="' + WHITE + '" stroke="' + NAVY + '" stroke-width="8"/>'
  ...
  function inner(pose) {
    return ''
      ...
      + limb("M94 214 L90 236") + limb("M126 214 L130 236")
  ...
  root.OrbiChar = {
    svg: svg, faceSvg: faceSvg, inner: inner,
    palette: { NAVY: NAVY, SUN: SUN, BLUE: BLUE, CORAL: CORAL, BLUESOFT: BLUESOFT }
  };
